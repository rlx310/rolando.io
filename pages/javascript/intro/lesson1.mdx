...
thousands of tiny light bulbs with "0" representing the light being off, and
...
came different scripting languages with varying syntax and ways of interacting with
...
ends up getting implemented into web browsers as JavaScript.
...
- JavaScript is the most widely used language, and has been adopted on platforms outside of just web browsers
